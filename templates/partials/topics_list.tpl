<ul component="category" class="topic-list" itemscope itemtype="http://www.schema.org/ItemList" data-nextstart="{nextStart}" data-set="{set}">
	...
	<li component="category/topic" class="row clearfix category-item {function.generateTopicClass}" <!-- IMPORT partials/data/category.tpl -->>
		...
		<div class="col-md-1 hidden-sm hidden-xs stats stats-votes">
			...
			<small title="[[global:votes]]" class="fa fa-thumbs-up"></small>
			<!-- END -->
		</div>
		...
		<div class="col-md-1 hidden-sm hidden-xs stats stats-postcount">
			<small title="[[global:posts]]" class="fa fa-commenting-o"></small> <span class="human-readable-number" title="{topics.postcount}">{topics.postcount}</span><br />
			<small title="[[global:views]]" class="fa fa-eye"></small> <span class="human-readable-number" title="{topics.viewcount}">{topics.viewcount}</span><br />
		</div>
